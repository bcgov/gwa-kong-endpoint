...
build = {
  type = "builtin",
  modules = {
    ["kong.plugins.bcgov-gwa-endpoint.migrations.000_base_bcgov_gwa_endpoint"] = "kong/plugins/bcgov-gwa-endpoint/migrations/000_base_bcgov_gwa_endpoint.lua",
    ["kong.plugins.bcgov-gwa-endpoint.migrations.001_100_to_200"] = "kong/plugins/bcgov-gwa-endpoint/migrations/001_100_to_200.lua",
